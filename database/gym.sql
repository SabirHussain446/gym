...
CREATE TABLE `assets` (
  ...
  `purchase_date` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `plans` (
  ...
  `name` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(210) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trainee` (
  ...
  `name` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
  `f_name` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
  `gender` varchar(254) COLLATE utf8mb4_unicode_ci NOT NULL,
  `age` int(11) NOT NULL,
  `plan_id` int(11) NOT NULL,
  `package_id` int(11) NOT NULL,
...
--
ALTER TABLE `trainee`
  MODIFY `trainee_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `trainers`
--
ALTER TABLE `trainers`
  MODIFY `trainer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
COMMIT;
