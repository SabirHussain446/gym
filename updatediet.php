                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        ...
                                        $query = mysqli_query($conn, "SELECT * from diet where diet_id=$diet_id");
...
$conn = mysqli_connect('localhost', 'root', '', 'gym');
$query = mysqli_query($conn, "UPDATE diet set name='$name', description='$description' where diet_id='$diet_id' ");
